...
def main():
    ...
    # tab_data = [{'time': 0, 'string': 1, 'fret': 1, 'note_name': 'A', 'color': (0, 0, 0)}, {'time': 1741, 'string': 2, 'fret': 2, 'note_name': 'E', 'color': (0, 0, 0)}, {'time': 3511, 'string': 3, 'fret': 3, 'note_name': 'E', 'color': (0, 0, 0)}]
